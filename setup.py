...
setup(
    ...
    options = {
        'py2exe' : {
            'packages': 'encodings',
            'includes': 'cairo,pango,pangocairo,atk,gobject,win32com.shell,win32api,win32com,win32ui,win32gui,pygments,colorama,pygtk,gtk,pygments, pygments.styles.default,     pygments.lexers.agile,pygments.lexers.asm,pygments.lexers.compiled,pygments.lexers.dalvik,pygments.lexers.dotnet,pygments.lexers.foxpro,pygments.lexers.functional,pygments.lexers.hdl,pygments.lexers.jvm,pygments.lexers.math,pygments.lexers.other,pygments.lexers.parsers,pygments.lexers.shell,pygments.lexers.special,pygments.lexers.sql,pygments.lexers.templates,pygments.lexers.text,pygments.lexers.web, pygments.styles.autumn,pygments.styles.borland,pygments.styles.bw,pygments.styles.colorful,pygments.styles.default,pygments.styles.emacs,pygments.styles.friendly,pygments.styles.fruity,pygments.styles.manni,pygments.styles.monokai,pygments.styles.murphy,pygments.styles.native,pygments.styles.pastie,pygments.styles.perldoc,pygments.styles.rrt,pygments.styles.tango,pygments.styles.trac,pygments.styles.vim,pygments.styles.vs',
